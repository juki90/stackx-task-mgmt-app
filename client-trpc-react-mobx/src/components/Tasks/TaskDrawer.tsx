...
export const TaskDrawer: FC<ITaskDrawer> = observer(
    ({ viewedTaskId, setViewedTask, setIsCreateOrUpdateModalOpen }) => {
        const {
            task,
            cancelTask,
            taskToDelete,
                    ...
                    {task && !isTaskRefetching && isResponseTaskSuccess ? (
                        <>
                            ...
                            <Box>
                                ...
                                <StyledTaskContent>
                                    You can filter users by clicking column
                                    icons.
                                </StyledTaskContent>
                                <DataGrid
                            ...
                            <ConfirmDialog
                                ...
                                errorMessage={
                                    cancelTask?.formError ||
                                    cancelTask?.otherError
                                }
                                handleConfirm={() =>
