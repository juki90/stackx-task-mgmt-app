...
export const CreateOrUpdateTask: FC<ICreateOrUpdateTask> = observer(
    ({ task, isModalOpen, setIsCreateOrUpdateModalOpen }) => {
        const {
            theme,
            isFormValid,
            titleErrorMessage,
                        ...
                        <form>
                            <StyledTextField
                                ...
                                inputProps={{
                                    ...
                                    onChange:
                                        titleFieldController.field.onChange,
                            ...
                            <StyledTextField
                                ...
                                inputProps={{
                                    value: descriptionFieldController.field
                                        .value,
                                    onChange:
                                        descriptionFieldController.field
                                            .onChange,
                                    onBlur: descriptionFieldController.field
                                        .onBlur
                                }}
                            ...
                            >
                                Assign users to this task. It should be assigned
                                to at least 1 user or many, up to 50 users
                            </Typography>
                            <UserListPicker
