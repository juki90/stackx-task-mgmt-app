...
export const CreateOrUpdateUser: FC<ICreateOrUpdateUser> = observer(
    ({ user, isModalOpen, setIsCreateOrUpdateModalOpen }) => {
        const {
            theme,
            loggedUser,
            isFormValid,
                        ...
                        <form>
                            <StyledTextField
                                ...
                                inputProps={{
                                    ...
                                    onBlur: firstNameFieldController.field
                                        .onBlur
                                }}
                            ...
                            <StyledTextField
                                ...
                                inputProps={{
                                    ...
                                    onChange:
                                        emailFieldController.field.onChange,
                            ...
                            (loggedUser as User)?.id !== user?.id ? (
                                ...
                                >
                                    <Checkbox
                                        checked={
                                            isAdminFieldController.field.value
                                        }
                                        onChange={e =>
                                        ...
                                        onBlur={
                                            isAdminFieldController.field.onBlur
                                        }
                                ...
                                <Typography sx={{ marginBottom: '15px' }}>
                                    The user will be{' '}
                                    {user ? 'updated' : 'created'} as a regular
                                    user
                                </Typography>
                            ) : (
                                <Typography sx={{ marginBottom: '15px' }}>
